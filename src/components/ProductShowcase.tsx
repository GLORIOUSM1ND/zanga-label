...
const ProductShowcase = ({ selectedCategory, setSelectedCategory, addToCart, darkMode }) => {
  ...
  const products = [
    {
      id: 1,
      name: "ZANGA LABEL STREET IMMORTAL TOP",
      category: "Tops",
      colors: ["White", "Black"],
      ...
      badge: "COMING SOON",
      isHot: false,
      description: "🔥 A legendary drop is on the horizon. Engineered for the bold, built for the immortal. Stay sharp.",
      images: ['/zanga-images/comingsoon1.jpg', '/zanga-images/comingsoon2.jpg'],
